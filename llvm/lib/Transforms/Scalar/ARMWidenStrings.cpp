...
bool ARMWidenStrings::run(Function &F) {
  ...
  for (Function::iterator b = F.begin(); b != F.end(); ++b) {
    for (BasicBlock::iterator i = b->begin(); i != b->end(); ++i) {
      ...
      // Not widening strings for this memcpy because it's a volatile operations
      ...
      // Make sure destination is definitely a char array.
      ...
      // Updating users of destination stack object to use
